...
% Initial guess of alpha2f? which produces rho vector   
...
if(params.hwnorm==1)
    ...
    rhovecini=a2Fini.*params.delta./factor;
end
...
alpha1=0;
alpha2=0;
multiplier=0.1;     %Used to calculate next alpha in Dogleg method
j=1;
k=1;
%-----------------------------iteration for alpha--------------------------
flag1=0;
